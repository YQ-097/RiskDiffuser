...
class Encoder(nn.Module):
    ...
    def forward(self, inputs):
        ...
        encoding_mask_batched = torch.cat([neighbors_mask, static_mask, lanes_mask], dim=1)

        #encoder_outputs['encoding'] = self.fusion(encoding_input, encoding_mask_batched)
        encoder_outputs['encoding_mask'] = encoding_mask_batched
