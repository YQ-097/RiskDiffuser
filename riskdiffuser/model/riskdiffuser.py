...
from riskdiffuser.model.module.encoder import Encoder
from riskdiffuser.model.module.decoder import Decoder


class RiskDiffuser(nn.Module):
    def __init__(self, config):
        super().__init__()

        self.encoder = RiskDiffuser_Encoder(config)
        self.decoder = RiskDiffuser_Decoder(config)
...
class RiskDiffuser_Encoder(nn.Module):
    def __init__(self, config):
        super().__init__()
...
class RiskDiffuser_Decoder(nn.Module):
    def __init__(self, config):
        super().__init__()
